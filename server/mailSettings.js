...
export const mailEventDefinitions = [
  ...
  },
  {
    ...
    sampleContext: {
      appName: APP_NAME,
      actionType: "CREATE",
      resource: "Teslimat Listeleri",
      resourceId: "dlv-xxx",
      userName: "Ornek Tedarikci",
      userRole: "Tedarikci",
      description: "Yeni teslimat listesi olusturuldu",
      ipAddress: "192.168.1.1",
      actionAt: "22.04.2026 14:30",
    },
    conditionFields: [
      {
        key: "actionType",
        ...
        options: [
          { value: "LOGIN",     label: "Giris (LOGIN)" },
          { value: "CREATE",    label: "Olusturma (CREATE)" },
          { value: "UPDATE",    label: "Guncelleme (UPDATE)" },
          { value: "DELETE",    label: "Silme (DELETE)" },
          { value: "LIST",      label: "Listeleme (LIST)" },
          { value: "GET",       label: "Goruntuleme (GET)" },
          { value: "PAGE_VIEW", label: "Sayfa Goruntuleme (PAGE_VIEW)" },
        ],
      },
      {
        key: "resource",
        ...
        operators: ["equals", "not_equals", "is_empty", "is_not_empty"],
        options: [
          { value: "Auth",                label: "Auth (Giris/Cikis)" },
          { value: "Teslimat Listeleri",  label: "Teslimat Listeleri" },
          { value: "Magazalar",           label: "Magazalar" },
          { value: "Magaza Gonderileri",  label: "Magaza Gonderileri" },
          { value: "Urunler",             label: "Urunler" },
          { value: "Tedarikciler",        label: "Tedarikciler" },
          { value: "POS Oturumlari",      label: "POS Oturumlari" },
          { value: "POS Satislar",        label: "POS Satislar" },
          { value: "POS Iadeler",         label: "POS Iadeler" },
          { value: "Stok Girisleri",      label: "Stok Girisleri" },
          { value: "Stok Hareketleri",    label: "Stok Hareketleri" },
          { value: "Hakedis Kayitlari",   label: "Hakedis Kayitlari" },
          { value: "Kullanicilar",        label: "Kullanicilar" },
          { value: "Sozlesmeler",         label: "Sozlesmeler" },
