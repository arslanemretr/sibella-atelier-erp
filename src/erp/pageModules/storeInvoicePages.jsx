...
export function StoreInvoiceListPage() {
  ...
  const columns = [
    ...
    { title: "KDV Oranı", dataIndex: "kdvRate", key: "kdvRate", width: 90, align: "center", render: (v) => `%${v}` },
    { title: "KDV Tutarı", dataIndex: "kdvAmount", key: "kdvAmount", width: 130, align: "right", render: formatMoney },
    { title: "Hizmet Tutarı", dataIndex: "serviceAmount", key: "serviceAmount", width: 140, align: "right", render: formatMoney },
    { title: "İlgili Dönem", dataIndex: "periodKey", key: "periodKey", width: 130, render: periodLabel },
    { title: "Vade Tarihi", dataIndex: "dueDate", key: "dueDate", width: 120, render: formatDate },
