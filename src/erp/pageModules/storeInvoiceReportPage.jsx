...
export default function StoreInvoiceReportPage() {
  ...
  const tableColumns = [
    ...
    { title: "Tarih",        dataIndex: "invoiceDate",   key: "invoiceDate",   width: 110, render: fmtDate },
    { title: "Toplam",       dataIndex: "totalAmount",   key: "totalAmount",   width: 130, align: "right", render: fmt },
    { title: "KDV %",        dataIndex: "kdvRate",       key: "kdvRate",       width: 75,  align: "center", render: (v) => `%${v}` },
    { title: "KDV Tutar",    dataIndex: "kdvAmount",     key: "kdvAmount",     width: 120, align: "right", render: fmt },
    { title: "Hizmet Tutar", dataIndex: "serviceAmount", key: "serviceAmount", width: 130, align: "right", render: (v) => <Text strong>{fmt(v)}</Text> },
    { title: "Dönem",        dataIndex: "periodKey",     key: "periodKey",     width: 120, render: periodLabel },
    { title: "Vade",         dataIndex: "dueDate",       key: "dueDate",       width: 110, render: fmtDate },
  ];
