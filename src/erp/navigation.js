export const mainMenuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "/stores/sales", label: "Magaza Satislar", permissionKey: "stores_invoices" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "/reports/consolidated-sales", label: "Konsolide Satış Raporu", permissionKey: "stores_invoices" },
    ],
  },
  {
    key: "settings",
    ...
    children: [
      ...
      { key: "/settings/ai-settings", label: "AI Ayarlari", permissionKey: "settings_ai" },
      { key: "/settings/ai-console", label: "AI Test Konsolu", permissionKey: "settings_ai_console" },
      { key: "/settings/ai-entry-console", label: "AI Veri Giris Konsolu", permissionKey: "settings_ai_entry_console" },
    ],
  },
];
